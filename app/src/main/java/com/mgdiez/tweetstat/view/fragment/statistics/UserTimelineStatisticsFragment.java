...
import com.mgdiez.tweetstat.presenter.UserTimelineStatisticsPresenter;
...
public class UserTimelineStatisticsFragment extends BaseFragment implements StatisticAdapter.OnStatisticClickedListener{

    @Bind(R.id.my_recycler_view)
    RecyclerView recyclerView;

    private UserTimelineStatisticsPresenter userTimelineStatisticsPresenter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.hometimeline_statistics_fragment, container, false);
        ButterKnife.bind(this, v);
        userTimelineStatisticsPresenter = new UserTimelineStatisticsPresenter(this);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        userTimelineStatisticsPresenter.getTimelineStatistics();
        return v;
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        userTimelineStatisticsPresenter.destroy();
    }

    public static Fragment newInstance() {
        return new UserTimelineStatisticsFragment();
    }
