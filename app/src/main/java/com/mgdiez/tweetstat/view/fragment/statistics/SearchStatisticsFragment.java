...
import com.mgdiez.tweetstat.presenter.SearchStatisticsPresenter;
...
public class SearchStatisticsFragment extends BaseFragment implements StatisticAdapter.OnStatisticClickedListener{

    @Bind(R.id.my_recycler_view)
    RecyclerView recyclerView;

    private SearchStatisticsPresenter searchStatisticsPresenter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.hometimeline_statistics_fragment, container, false);
        ButterKnife.bind(this, v);
        searchStatisticsPresenter = new SearchStatisticsPresenter(this);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        searchStatisticsPresenter.getSearchStatistics();
        return v;
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        searchStatisticsPresenter.destroy();
    }

    public static Fragment newInstance() {
        return new SearchStatisticsFragment();
    }
