...
public class GetSearchUseCase extends UseCase {
    ...
    @Inject
    public GetSearchUseCase(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread,
                              TweetsRepository tweetsRepository) {
        super(threadExecutor, postExecutionThread);
        this.tweetsRepository = tweetsRepository;
    }

    public void execute(String search, boolean refresh, Subscriber useCaseSubscriber) {
    ...
    protected Observable buildUseCaseObservable() {
        return tweetsRepository.getTweetsBySearch(query,refresh);
    }
}
